#!/usr/bin/perl
#Modified version of Bill's script that creates the test set using
#genes, not transcripts, does not care about neighboring genes, and
#chooses both single- and multiple-isoform genes.
use strict;
use FastaReader;
use CompiledFasta;
use FastaWriter;
